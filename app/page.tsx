          ...
          <div className={`${styles.flexWrap} `} >
            <div className="m-10  min-w-[350px] flex flex-col justify-center items-center ">
              ...
              <div className={styles.biographyContainer}>
                <span className="ml-10"></span><span className={styles.biography}>Maui, HI born & raised. Critical thinker, problem solver, former chef, and avid jiu-jitsu practitioner. I had a fun growing up on the island's country side with so much to do and explore. I always had good work ethic, always bulding or fixing things, and I became a jack of all trades. When we weren't working we where either in the jungle or in the ocean, and we used to skip school when the surf was to good to pass up.</span><br></br> <span className="ml-10"></span><span className={styles.biography}> I was always interested in making good food, so I started with culinary school where I earned my degree and became a Chef. The restaurant industry was a playground of fun opportunities, from working in bars and dives to catering and upscale restaurants. After some time, a unique opportunity in the towing industry came my way, and I seized it. This phase of my life was full of unique experiences, from repossessions to off-road tow-outs and vehicle removals, all kinds of challenging situations.</span><br></br> <span className="ml-10"></span><span className={styles.biography}>Eventually I had enough and I sought a new path and turned to construction, where I gained valuable skills. However, I realized that it wasn't where I wanted my future. I discovered I had a keen interest in programming, having fun in creating and seeing technology come to life. To refine my skills, I attended an intensive 16-week coding bootcamp at Coding Dojo, coding 12 to 15 hours a day. This rigorous training whipped me into coding shape. Now, I have the privilege of working on and creating amazing software. Where I get to employ my own personal philosophy to continually improve, and innovate.</span><span className={styles.bioRed}>If you have any questions or just want to chat, feel free to get in touch. Mahalo!</span>
              </div>
            </div>
